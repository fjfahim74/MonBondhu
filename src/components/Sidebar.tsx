  ...
  return (
    <aside className="hidden lg:block w-64 shrink-0">
      <div className="space-y-4 sticky top-20">
        ...
        {/* Emergency Support */}
        <div className="card p-4 bg-gradient-to-br from-accent-50 to-accent-100 dark:from-accent-950 dark:to-accent-900 border-accent-200 dark:border-accent-800">
          <h3 className="font-semibold mb-2 text-accent-900 dark:text-accent-200">জরুরি সহায়তা</h3>
          <p className="text-sm text-accent-800 dark:text-accent-300 mb-3">
            মানসিক স্বাস্থ্য সংকটে আছেন?
          </p>
          <Link href="/help" className="btn-accent w-full text-sm">
            এখনই যোগাযোগ করুন
          </Link>
        </div>
      </div>
